    ...
    public partial class AddFirstEntity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StorehouseType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorehouseTypeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.StorehouseTypeId,
                        principalTable: "StorehouseType",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Storehouses_CityId",
                table: "Storehouses",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_Storehouses_CountryId",
                table: "Storehouses",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_Storehouses_StorehouseTypeId",
                table: "Storehouses",
