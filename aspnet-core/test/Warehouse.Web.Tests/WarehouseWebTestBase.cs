...
{
    public abstract class WarehouseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WarehouseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WarehouseWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WarehouseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WarehouseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WarehouseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WarehouseDbContext, Task<T>> func)
        {
            T result;
